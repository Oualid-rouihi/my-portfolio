...
const projects = [
  ...
  },
  {
    ...
    description: 'A website containing a complete collection of high-resolution Quran pages alongside a comprehensive library of daily adhkar (supplications and remembrances). Users can browse and zoom Quran pages, search and filter adhkar.',
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <span className="block bg-clip-text bg-gradient-to-r from-gray-100 to-gray-300">Walid Rouihi.</span>
...
<motion.p 
          ...
          >
            I'm a passionate <span className="text-blue-300 font-medium">Full-Stack Developer</span> with 3 years of experience building dynamic and scalable web applications. Holding a diploma in [Your Field, e.g., Computer Science], I specialize in creating user-centric solutions that blend performance, functionality, and modern design.
          </motion.p>
